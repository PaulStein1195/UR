...
class _SearchPageState extends State<SearchPage> {
  ...
  Widget _userSearchField() {
    return Container(
      ...
      child: TextField(
        autocorrect: false,
        style: TextStyle(color: Color(0XFF576574)),
        onSubmitted: (_input) {
          setState(() {
            _searchText = _input;
          });
        ...
        decoration: InputDecoration(
          ...
          labelStyle: TextStyle(color: Color(0XFF576574), fontFamily: "PT-Sans"),
          labelText: "Search",
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext _context, int _index) {
                    ...
                    return ListTile(
                      ...
                      title: Text(_userData.name, style: TextStyle(fontFamily: "PT-Sans", color: Color(0xFF222f3e)),),
                      leading: Container(
                        width: 50,
                        height: 50,
