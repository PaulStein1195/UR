                        ...
                        children: [
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: Center(child: Text(_currentUser.getCurrentUser.name[0], style: TextStyle(color: Colors.white70, fontSize: 35.0, fontWeight: FontWeight.w700),)),
                            ),
                          ),
                          Column(
                            mainAxisAlignment: MainAxisAlignment.start,
                            ...
                            children: [
                              Text(
                                _currentUser.getCurrentUser.name,
                                style: TextStyle(
